...
Score: 3/3
Well done! You've provided a clear and accurate example of inheritance in JavaScript. The way you've structured the code makes it easy to see how the Beagle class inherits from the Dog class and how the methods from the parent class can be invoked on an instance of the child class.
